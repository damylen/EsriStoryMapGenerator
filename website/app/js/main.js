...
function buildLayer(arr,iconDir,root) {
	...
	$.each(arr,function(index,value){
		...
		sym = createPictureMarkerSymbol(value.attributes["ico_url"], _lutIconSpecs["tiny"]); //("resources/images/icons/"+iconDir+"/"+root+value.attributes.getValueCI(FIELDNAME_NUMBER)+".png"
...
function showDetails(graphic, e) {
	...
	var imageDiv = $('<img alt="" tabindex="-1" src="'+graphic.attributes['pic_url']+'">');
